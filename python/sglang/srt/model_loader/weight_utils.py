...
def pad_loaded_weight(loaded_weight, output_dim, output_sizes):
    ...
    if total_output_size > raw_output_size:
        loaded_weight_pad = []
        weight_split_size = [int(output_size / total_output_size * raw_output_size) for output_size in output_sizes]
        ...
        for i, output_size in enumerate(output_sizes):
            ...
            loaded_weight_pad.append(torch.cat([split_weight[i], pad_tensor], dim=output_dim))
