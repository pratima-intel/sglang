...
// template <>
// inline int get_cache_blocks<at::quint4x2>(int chunk_size) {
//   // int4-a16 uses bf16 as accumulate type
//   int cache_block_size = get_cache_blocks<at::BFloat16>(chunk_size);
//   return std::min(MAX_CACHE_BLOCK_SIZE, cache_block_size);
// }

// template <>
// inline int get_cache_blocks<int8_t>(int chunk_size) {
//   // int4-a8 uses int8 as accumulate type
//   int cache_block_size = get_cache_blocks<at::BFloat16>(chunk_size);
//   return std::min(MAX_CACHE_BLOCK_SIZE, cache_block_size);
// }
